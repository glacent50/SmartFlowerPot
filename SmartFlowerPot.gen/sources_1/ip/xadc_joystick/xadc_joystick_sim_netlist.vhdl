...
--               /home/user22/workspace_semicon/SmartFlowerPot/SmartFlowerPot.gen/sources_1/ip/xadc_joystick/xadc_joystick_sim_netlist.vhdl
...
entity xadc_joystick is
  ...
  attribute NotValidForBitStream of xadc_joystick : entity is true;
end xadc_joystick;

architecture STRUCTURE of xadc_joystick is
  ...
  signal NLW_inst_ALM_UNCONNECTED : STD_LOGIC_VECTOR ( 6 downto 1 );
...
inst: unisim.vcomponents.XADC
    generic map(
      ...
      SIM_MONITOR_FILE => "design.txt"
        ...
        port map (
      ALM(7) => alarm_out,
      ALM(6 downto 1) => NLW_inst_ALM_UNCONNECTED(6 downto 1),
